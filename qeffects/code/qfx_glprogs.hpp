...
//==========================================================================
// Pixelate - lower res of game and make it blocky
//==========================================================================
static const char g_szVertexShader_Pixelate[] =
"#version 130\n"
"void main(void)\n"
"{\n"
	"gl_TexCoord[0] = gl_MultiTexCoord0;\n"
...
static const char g_szFragmentShader_Pixelate[] =
"#version 130\n"
"#extension GL_ARB_texture_rectangle : enable\n"
"uniform sampler2DRect Texture0;\n"
"uniform vec4 Local0;\n" //m_varPixelate
...
"{\n"
	...
	"vec2 correctedCoord = gl_FragCoord.xy / screenHeight;\n"
	"vec2 pixelatedCoord = floor(correctedCoord * relativePixelSize) / relativePixelSize;\n"
	"vec3 color = texture2DRect(Texture0, pixelatedCoord * screenHeight).rgb; \n"
