...
#define QFX_GAME_DIRECTORY				"id1"
#define QFX_LIBRARY_TITLE				"QFXShaders"//"QeffectsGL"
#define QFX_LIBRARY_VERSION				"1.4"
#define QFX_LIBRARY_VENDOR				"Electric Company (" QFX_LIBRARY_TITLE " " QFX_LIBRARY_VERSION ")"
