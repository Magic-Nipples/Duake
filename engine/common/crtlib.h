...
// crtlib.c
//
#define Q__strupr( in, out ) Q_strnupr( in, out, 99999 )
...
#define Q__stricmp( s1, s2 ) Q__strnicmp( s1, s2, 99999 )
int Q__strnicmp( const char *s1, const char *s2, int n );
#define Q_strcmp( s1, s2 ) Q_strncmp( s1, s2, 99999 )
int Q_strncmp( const char *s1, const char *s2, int n );
qboolean Q__stricmpext( const char *s1, const char *s2 );
