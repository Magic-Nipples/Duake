...
void PicAdjustSize( float *x, float *y, float *w, float *h, int iFlags ); //QUAKE - added flag param
...
void pfnPIC_DrawMessage(int x, int y, int width, int height, const wrect_t* prc); //QUAKE
