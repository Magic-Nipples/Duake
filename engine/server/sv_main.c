...
// physic-related variables //WOLF3D
CVAR_DEFINE_AUTO( sv_gravity, "800", FCVAR_MOVEVARS, "world gravity value" );
CVAR_DEFINE_AUTO( sv_stopspeed, "15", FCVAR_MOVEVARS, "how fast you come to a complete stop" ); //100
CVAR_DEFINE_AUTO( sv_maxspeed, "583", FCVAR_MOVEVARS, "maximum speed a player can accelerate to when on ground" ); //320
CVAR_DEFINE_AUTO( sv_spectatormaxspeed, "500", FCVAR_MOVEVARS|FCVAR_UNLOGGED, "maximum speed a spectator can accelerate in air" );
CVAR_DEFINE_AUTO( sv_accelerate, "4", FCVAR_MOVEVARS, "rate at which a player accelerates to sv_maxspeed" ); //10
CVAR_DEFINE_AUTO( sv_airaccelerate, "4", FCVAR_MOVEVARS, "rate at which a player accelerates to sv_maxspeed while in the air" );
CVAR_DEFINE_AUTO( sv_wateraccelerate, "4", FCVAR_MOVEVARS, "rate at which a player accelerates to sv_maxspeed while in the water" );
CVAR_DEFINE_AUTO( sv_friction, "5.2", FCVAR_MOVEVARS, "how fast you slow down" ); //4
CVAR_DEFINE( sv_edgefriction, "edgefriction", "2", FCVAR_MOVEVARS, "how much you slow down when nearing a ledge you might fall off" );
CVAR_DEFINE_AUTO( sv_waterfriction, "2", FCVAR_MOVEVARS, "how fast you slow down in water" ); //1
